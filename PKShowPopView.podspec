...
Pod::Spec.new do |spec|
  ...
  spec.description  = "A light tool to show pop view. support a couple of stysles"
  ...
  spec.source       = { :git => "https://github.com/LostPengK/PKShowPopView.git", :tag => "#{spec.version}" }
